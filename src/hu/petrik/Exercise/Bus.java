...
public class Bus {
    ...
    public static void Run() {
        ...
        Set<String> unio = hetesBuszMegalloi.intersect(otosBuszMegalloi);
        System.out.println(String.format( "Az ötösbusz %d helyen áll meg.", otosBuszMegalloi.getSize()));
        System.out.println(String.format( "A hetes %d helyen áll meg.", hetesBuszMegalloi.getSize()));
        System.out.println(String.format("A két busznak %d közös megállója van.", unio.getSize()));
        System.out.println("A két busz közös megállói: \n " + unio.toString());
    }
}
